"""
From-scratch neural network classes used by the MNIST project.

Every class here was built incrementally across posts/01..31. This module
collects the final versions in one place so train.py and evaluate.py can
import them.
